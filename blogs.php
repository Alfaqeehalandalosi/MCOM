                ...
                <div class="main-menu-wrapper">
                    <nav class="navigation">
                      <ul class="sf-menu">
                        ...
                        <li><a href="gallery-2cols-pagination.php">Gallery</a>
                          <ul class="dropdown">
                            <li><a href="gallery-2cols-pagination.php">With Pagination</a>
                              <ul class="dropdown">
                                <li><a href="gallery-2cols-pagination.php">2 Columns</a></li>
                                <li><a href="gallery-3cols-pagination.php">3 Columns</a></li>
                                <li><a href="gallery-4cols-pagination.php">4 Columns</a></li>
                              </ul>
                            </li>
          ...
          <div class="col-md-12 posts-archive blog-full-width">
            <article class="post">
              <div class="row">
                <div class="col-md-3 col-sm-3">
                  <span class="post-meta meta-data"> <span><i class="fa fa-calendar"></i> 28th Jan, 2025</span><span><i class="fa fa-archive"></i> <a href="#">Uncategorized</a></span> <span><a href="#"><i class="fa fa-comment"></i> 12</a></span></span>
                  </div>
                <div class="col-md-9 col-sm-9">
                  <h3><a href="single-event.php">A sample post title</a></h3>
                	<a href="single-event.php"><img src="http://placehold.it/1200x427&amp;text=IMAGE+PLACEHOLDER" alt="" class="img-thumbnail"></a>
            ...
            <article class="post">
              <div class="row">
                ...
                <div class="col-md-9 col-sm-9">
                  <h3><a href="single-event.php">An example post with a video from vimeo.com</a></h3>
            ...
            <article class="post">
              <div class="row">
                ...
                <div class="col-md-9 col-sm-9">
                  <h3><a href="single-event.php">A soundcloud embedding example post</a></h3>
            ...
            <ul class="pagination">
              ...
              <li><a href="blogs.php?blogs=1">1</a></li>
              <li><a href="blogs.php?blogs=2">2</a></li>
              <li><a href="blogs.php?blogs=3">3</a></li>
              <li><a href="blogs.php?blogs=4">4</a></li>
              <li><a href="blogs.php?blogs=5">5</a></li>
...
<script src="js/jquery-2.0.0.min.js"></script> <script src="plugins/prettyphoto/js/prettyphoto.js"></script> <script src="js/helper-plugins.js"></script> <script src="js/bootstrap.js"></script> <script src="js/waypoints.js"></script> <script src="plugins/mediaelement/mediaelement-and-player.min.js"></script> <script src="js/init.js"></script> <script src="plugins/flexslider/js/jquery.flexslider.js"></script> <script src="plugins/countdown/js/jquery.countdown.min.js"></script> <script src="js/blogs.js"></script> </body>
</html>