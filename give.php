...
<head>
    ...
    <!-- All links are identical to Connect.html -->
    ...
    <style>
        /* All styles are identical to Connect.html */
        @font-face {
        ...
        :root {
            ...
            --bg-light: #f8f9fa;
            --border-color: #e0e0e0;
            --color-secondary-hover: #b2aeaa; /* Added for consistency */
        }
        ...
        * {
        ...
        /* Header styles from Connect.html */
        .site-header {
        ...
        .header-button .btn {
            ...
            border-radius: 5px; font-size: 0.85em; text-transform: uppercase; text-decoration: none;
        }
        .header-button .btn:hover { background-color: var(--text-light); color: var(--primary-dark); }
        
        /* Dropdown/Mega Menu Styles from Connect.html */
        .navigation li { position: relative; }
        .navigation .dropdown {
            display: none; position: absolute; background-color: #222;
            padding: 15px; border-top: 3px solid var(--accent-teal);
            list-style: none; width: 220px; left: 0; top: 100%;
        }
        ...
        .navigation .megamenu > .dropdown {
            width: 100%; max-width: 800px; left: 50%;
            transform: translateX(-50%); padding: 25px;
        }
        ...
        .hero-section { position: relative; padding: 20vh 0; text-align: center; }
        ...
        .hero-overlay-layer { position: absolute; top: 0; left: 0; right: 0; bottom: 0; background-color: rgba(0, 0, 0, 0.25); }
        ...
        .headline-group .pre-title { font-size: 1em; color: var(--color-secondary-hover); font-weight: 400; margin-bottom: 0.35em; }
        .headline-group .main-title { font-family: 'poynter-new', serif; font-size: 3em; line-height: 1.1; margin-bottom: 0.5em; color: var(--text-dark); }
        ...
        .btn {
            ...
            border-radius: 5px; text-decoration: none; margin-top: 1em;
            background-color: var(--primary-dark); color: var(--text-light);
        }
        .btn:hover { background-color: var(--color-secondary-hover); transform: translateY(-2px); }
        ...
        .ways-to-give-intro h2 { color: var(--color-secondary-hover); }
        .ways-to-give-intro h3 { font-family: 'poynter-new', serif; font-size: 3em; color: var(--text-light); }
        ...
        .card p { font-size: 1em; line-height: 1.4; color: var(--text-light); margin-top: 0.5em; }
        .card p a { color: var(--text-light); }

        /* Footer from Connect.html */
        ...
        .footer-col h4 { font-weight: 700; text-transform: uppercase; font-size: 1em; margin-bottom: 20px; }
        .footer-col p, .footer-col a { color: var(--text-muted); font-size: 0.9em; line-height: 1.6; text-decoration: none; }
        .footer-col a:hover { color: var(--text-light); }
        .footer-col ul { list-style: none; padding: 0; margin: 0; }
        .footer-col ul li { margin-bottom: 10px; }
        .footer-bar { background-color: var(--primary-dark); padding: 20px 0; box-shadow: 0 -3px 25px rgba(0, 0, 0, 0.15); }
        .footer-bar .container { display: flex; justify-content: center; align-items: center; }
        .footer-bar img { max-height: 40px; margin: 0 30px; }
        .footer-bar .line { height: 1px; flex-grow: 1; background-color: #333; }
        .footer-bottom { background-color: var(--primary-dark); padding: 20px 0; font-size: 0.8em; }
        .footer-bottom .container { display: flex; justify-content: space-between; align-items: center; flex-wrap: wrap; }
        .footer-social a { color: var(--text-muted); margin-left: 15px; }
    ...
    <!-- The exact stylesheet link from Connect.html -->
    <link rel="stylesheet" href="css/header.css">
</head>
<body>

    <!-- The header will be dynamically injected by js/header-loader.js -->
    <!-- The ID "site-header" from the original is what the JS will look for to add the "scrolled" class -->
        ...
        <section class="page-section section-dark">
            <div class="container">
                <div class="intro-section">
                    ...
                    <h3>we have multiple safe ways for you to give.</h3>
                </div>
    ...
    <!-- The exact script setup from Connect.html -->
    <script>
        // This is the verbatim scroll script from Connect.html
        const header = document.getElementById('site-header'); // Targets the header by ID
        window.onscroll = function() {
            // Because the loader hasn't run yet, we need to check if the header element exists.
    ...
    <script src="js/header-loader.js"></script> <!-- THIS IS THE KEY SCRIPT -->
