...
<head>
    ...
    <title>Next Steps - Cedarcrest Church | Acworth GA</title>
    
    <!-- Importing the same fonts from the original -->
    ...
    <style>
        ...
        :root {
            --primary-color: #47ab9d;
            --secondary-color: #b2aeaa;
            --dark-color: #272727;
            --light-color: #ffffff;
            --text-color: #999999;
            --accent-color: #47ab9d;
        ...
        * {
        ...
        /* Hero Section */
        .hero {
            background: linear-gradient(rgba(0,0,0,0.25), rgba(0,0,0,0.25)), url('https://cedarcrestchurch.com/wp-content/uploads/2022/07/next-steps-header_1920x1080.jpg');
        ...
        .section.visible .section-text p,
        .section.visible .section-text .btn {
            opacity: 1;
            transform: translateY(0);
        }
...
<body>
    ...
    <script>
        // Scroll to top button behavior (header handled by shared loader)
        ...
        gridImages.forEach(image => gridObserver.observe(image));
