...
<head>
    ...
    <title>Manifestation City Church</title>
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/4.7.0/css/font-awesome.min.css">
    <link rel="preconnect" href="https://fonts.googleapis.com">
    <link rel="preconnect" href="https://fonts.gstatic.com" crossorigin>
    <link href="https://fonts.googleapis.com/css2?family=Lato:wght@300;400;700;900&family=Open+Sans:wght@300;400;600;700&family=Playfair+Display:wght@700;900&display=swap" rel="stylesheet">

    <!-- This single CSS file will style the entire site -->
    <link rel="stylesheet" href="css/style.css">
</head>
<body>

    <!-- Header will be loaded here by the script -->
    <div id="header-placeholder"></div>

    <main>
        <section class="hero">
            <video class="hero-video-bg" poster="images/video-poster.jpg" playsinline autoplay muted loop>
            ...
            <div class="hero-content">
                ...
                <a href="about.html" class="btn">I'm New</a>
            </div>
        </section>
        ...
        <section class="content-section service-times">
          <div class="container split-section">
              <div class="service-right">
                  ...
                  <a href="events.html" class="btn">Plan Your Visit</a>
              </div>
        ...
        <section class="content-section coming-up-section">
            <div class="container split-section">
                ...
                <div>
                    ...
                    <a href="sermons.html" class="btn">Previous Messages</a>
                    <a href="sermons.html" class="btn secondary">Watch On-Demand</a>
                </div>
            </div>
        </section>
        ...
        <section class="content-section next-steps-section">
            <div class="container">
                ...
                <div class="next-steps-grid">
                    <a href="nextsteps.html" class="step-card">
                    ...
                    <a href="connect.html" class="step-card">
    ...
    <script>
        // This script is specific to the interactive grid on the index page
