      ...
      <div class="row">
        <div class="col-md-12">
          <ol class="breadcrumb" style="padding-top: 120px;">
            ...
            <li><a href="sermons.php">Albums</a></li>
            <li><a href="sermon-archive.php">Archive</a></li>
            <li class="active"></li>
          </ol>
        </div>
      </div>
        ...
        <div class="row">
          <div class="col-md-9">
            <header class="single-post-header clearfix">
              <div class="pull-right sermon-actions"> <a href="#" id="single-video" class="play-video-link" data-placement="top" data-toggle="tooltip" data-original-title="Video"><i class="fa fa-video-camera"></i></a> <a href="#" id="single-audio" class="play-audio-link" data-placement="top" data-toggle="tooltip" data-original-title="Audio" ><i class="fa fa-headphones"></i></a> <a href="#" id="single-read" data-placement="top" data-toggle="tooltip" data-original-title="Download Audio" ><i class="fa fa-download"></i></a> <a href="#" id="single-pdf" data-placement="top" data-toggle="tooltip" data-original-title="Download PDF"><i class="fa fa-book"></i></a> </div>
              <h2 class="post-title" id="single-title"></h2>
            </header>
            <article class="post-content">
              ...
              <div class="post-meta"> <i class="fa fa-tags"></i> <span id="single-tags"></span> </div>
            </article>
              ...
              <ol class="comments">
                <li>
                  <div class="post-comment-block">
                    <div class="img-thumbnail"> <img src="https://cdn-icons-png.flaticon.com/128/1077/1077114.png" alt="avatar"> </div>
                    <a href="#" class="btn btn-primary btn-xs pull-right">Reply</a>
                    <h5>John Doe says</h5>
                    <span class="meta-data">Nov 23, 2025 at 7:58 pm</span>
...
<script src="js/single.js"></script> <!-- Single Pagination -->
</body>
</html>