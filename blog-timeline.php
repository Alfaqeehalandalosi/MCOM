  ...
  <div class="main" role="main">
    <div id="content" class="content full">
      <div class="container">
        <ul class="timeline">
            <li>
              <div class="timeline-badge">Mar<span>2024</span></div>
              <div class="timeline-panel">
                <div class="timeline-heading">
                  <h3 class="timeline-title"><a href="blog-post.php">A sample post title</a></h3>
                  <p><small class="text-muted"><i class="fa fa-calendar"></i> 28th March, 2024</small></p>
                </div>
            ...
            <li>
              <div class="timeline-badge">Feb<span>2024</span></div>
              <div class="timeline-panel">
                <div class="timeline-heading">
                  <h3 class="timeline-title"><a href="blog-post.php">A sample post title</a></h3>
                  <p><small class="text-muted"><i class="fa fa-calendar"></i> 28th March, 2024</small></p>
